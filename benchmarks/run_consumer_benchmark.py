...
if __name__ == "__main__":
    ...
    if args.instances == 1:
        processes.append(run_consumer_script(args.topic, args.broker, fetch_size, total_records, REPORTING_INTERVAL,
                                             TIMEOUT, args.output))
    else:
        ...
        for i in range(args.instances):
            ...
            processes.append(run_consumer_script(args.topic, args.broker, fetch_size, total_records,
                                                 REPORTING_INTERVAL, TIMEOUT, output_path))
